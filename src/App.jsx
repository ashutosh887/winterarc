...
import { Check, Flame, Trophy, ExternalLink, Sparkles, Snowflake, Shield, Zap, BookOpen, Dumbbell, Star, ArrowRight, Heart, X, User, Settings, Menu, Footprints, Moon, Salad, Egg, Droplets, Target, Ban, Wind, NotebookPen, Sun, PhoneOff, TreePine, Coins, BrushCleaning, ShowerHead, AlarmClock, MountainSnow, Hourglass, Gem, Crown, Rocket, GraduationCap, Lock, TriangleAlert, Quote } from 'lucide-react'
...
const getDefaultArc = () => {
  ...
  const t = new Date(); const isBeforeOct = t.getMonth() < 9 // Jan-Sep
  const year = isBeforeOct ? y : y // keep current year for Oct-Dec, next year handled after Jan
    ...
    <div className="min-h-screen">
        ...
        <main>
          ...
          <section id="main" className="relative max-w-[980px] mx-auto px-6 pt-16 sm:pt-24 pb-12 overflow-hidden aurora rounded-3xl card-glow">
            ...
            <div className="flex justify-center">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-zinc-800 bg-zinc-900/60 text-[11px] font-mono tracking-widest text-zinc-400">
                <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" /> Winter arc 2026. Oct 1 to Dec 31. 92 days
              </div>
            </div>
            ...
            <div className="mt-10 text-center">
              ...
              {todayYMD() < DEFAULT_START && (
                <div className="mt-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-xs font-mono text-amber-200">
                  September is prep. {daysBetween(todayYMD(), DEFAULT_START)} days to Oct 1. Set your arc now
                </div>
              )}
              <p className="mt-5 max-w-[560px] mx-auto text-[15px] leading-6 text-zinc-500">
                A private tracker for your 90 day lock in. No account. No cloud.<br className="hidden sm:block" /> Data stays on your device.
              </p>
              ...
              <div className="mt-3 inline-flex items-center gap-2 text-[11px] font-mono tracking-wide text-zinc-600"><Shield size={12} /> Free. No paywall. Works as pwa. trywinterarc.vercel.app</div>
            </div>
            ...
            <div className="mt-14 rounded-2xl border border-zinc-800 bg-zinc-900 overflow-hidden card-glow shine">
              ...
              <div className="grid md:grid-cols-[280px_1fr] gap-0">
                <div className="p-5 border-r border-zinc-800 bg-zinc-950/50">
                  ...
                  <div className="mt-4 flex items-center justify-between text-[11px] font-mono"><span className="text-zinc-500">3 / 5</span><span className="text-zinc-400">60 percent. Keep going</span></div>
                </div>
                <div className="p-5">
                  <div className="flex items-center justify-between"><span className="text-[11px] font-mono tracking-widest text-zinc-500">Oct to Dec grid</span><span className="text-[11px] font-mono text-zinc-600">Missed stays red. No restart</span></div>
          ...
          <section className="max-w-[980px] mx-auto px-6 py-10 border-y border-zinc-800/60">
            <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-zinc-800">
              <div className="py-6 md:py-2 md:pr-8">
                ...
                <div className="mt-2 text-[13px] leading-5 text-zinc-500">Gym. Steps. Sleep. No sugar. Protein. Water. Deep work. Pick three to five. Yes or no each day.</div>
              </div>
              <div className="py-6 md:py-2 md:px-8">
                <div className="text-[11px] font-mono tracking-widest text-zinc-500">02 good extras</div>
                <div className="mt-2 text-[14px] font-medium text-white">Useful extras</div>
              ...
              <div className="py-6 md:py-2 md:pl-8">
                ...
                <div className="mt-2 text-[14px] font-medium text-white">You do not need this to win</div>
          ...
          <section className="max-w-[980px] mx-auto px-6 py-12">
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { n: '01', t: 'Pick habits', d: 'Choose three to ten. Four or five is enough to start. Add your own. Keep it yes or no.' },
                { n: '02', t: 'Check daily', d: 'You can fill past days. Missed days stay red. No restart. The grid tells the truth.' },
                { n: '03', t: 'Share and export', d: 'Get a png for social. Track achievements. Export csv or json. Copy a prompt for your llm.' },
              ].map(s => (
      ...
      {view === 'templates' && (
        <main id="main" className="max-w-[980px] mx-auto px-6 py-10">
          ...
          <h1 className="mt-2 text-[28px] font-bold tracking-tight text-white">Pick a template</h1>
          <p className="mt-1 text-sm text-zinc-400">All habits are free. Edit <code className="px-1.5 py-0.5 rounded bg-zinc-900 border border-zinc-800">src/config.ts</code> and redeploy.</p>
      ...
      {view === 'challenges' && (
        <main id="main" className="max-w-[980px] mx-auto px-6 py-10">
          ...
          <p className="mt-1 text-sm text-zinc-400">All free. Progress comes from your arc. No backend. Config in <code className="px-1.5 py-0.5 rounded bg-zinc-900 border border-zinc-800">src/config.ts</code>.</p>
          <div className="mt-6 grid sm:grid-cols-2 gap-4">
            {challenges.map(c => {
      ...
      {view === 'resources' && (
        <main id="main" className="max-w-[980px] mx-auto px-6 py-10">
          ...
          <h1 className="mt-2 text-[28px] font-bold tracking-tight text-white">Free resources</h1>
          <p className="mt-1 text-sm text-zinc-400">All links are free. Edit <code className="px-1.5 py-0.5 rounded bg-zinc-900 border border-zinc-800">src/config.ts</code>.</p>
      ...
      {view === 'feedback' && (
        <main id="main" className="max-w-[980px] mx-auto px-6 py-10">
          ...
          <h1 className="mt-2 text-[28px] font-bold tracking-tight text-white">Suggest a feature</h1>
          <p className="mt-1 text-sm text-zinc-400">Winterarc is free and open source. Tell us what to build next.</p>
          <div className="mt-6 grid sm:grid-cols-2 gap-4">
          ...
          <div className="mt-6 rounded-2xl border border-zinc-800 bg-zinc-950 p-5">
            ...
            <ul className="mt-2 text-sm text-zinc-400 list-disc list-inside space-y-1">
              <li>Template you want. For example study arc or creator arc</li>
              <li>Resource link for <code className="px-1 py-0.5 rounded bg-zinc-900 border border-zinc-800">src/config.ts</code></li>
              <li>Bug or polish. For example date edge case</li>
            </ul>
      ...
      {view === 'tracker' && hasData && (
        <main className="max-w-[1120px] mx-auto px-4 sm:px-6 py-6">
          ...
          <div className="mt-6 rounded-2xl bg-zinc-900 border border-zinc-800 p-4 card-glow">
            ...
            <div className="mt-2 text-xs text-zinc-500">Paste with exported json into your llm. Data stays local until you paste. Reset asks for confirmation.</div>
          </div>
        </main>
      )}
        ...
        <main className="max-w-[1120px] mx-auto px-4 sm:px-6 py-6">
          <div className="grid lg:grid-cols-3 gap-4">
            <div className="rounded-2xl bg-zinc-900 border border-zinc-800 p-6 flex flex-col items-center">
              ...
              <div className="mt-4 text-sm text-zinc-300">{stats.perfect} perfect of {totalDays}. {stats.perfectPct} percent</div>
            ...
            <div className="rounded-2xl bg-zinc-900 border border-zinc-800 p-6">
              ...
              <div className="mt-4 space-y-3 text-sm">
                ...
                <div className="flex justify-between"><span className="text-zinc-400">Range</span><span className="text-white font-mono text-xs">{start} to {end}</span></div>
          ...
          <div className="mt-6 rounded-2xl bg-zinc-900 border border-zinc-800 p-4 card-glow">
            ...
            <div className="text-xs text-zinc-500 mt-1">Same milestones for everyone. Share any unlocked badge.</div>
          ...
          <div className="mt-6 rounded-2xl bg-sky-500/10 border border-sky-500/20 p-4">
            ...
            <p className="text-sm text-sky-200/80 mt-1">Data stays local. Install as pwa. Export weekly. Fill past days honestly if you missed.</p>
          </div>
        </main>
      )}
          ...
          <motion.div initial={{ opacity: 0, scale: 0.96, y: 8 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.96, y: 8 }} transition={{ type: 'spring', damping: 24, stiffness: 260 }} className="w-full max-w-[760px] max-h-[90dvh] overflow-y-auto overscroll-contain rounded-[24px] bg-zinc-900 border border-zinc-800 p-4 sm:p-6 shadow-2xl">
            ...
            {onboardStep === 1 && (
              <div className="mt-6">
                ...
                <p className="text-sm text-zinc-400 mt-1">It just personalises your arc. Stored locally only.</p>
                <div className="mt-4 space-y-2">
                ...
                <div className="mt-3 text-xs font-mono text-zinc-500">You can skip. We will just say your arc.</div>
            ...
            {onboardStep === 2 && (
              <div className="mt-6">
                ...
                <p className="text-sm text-zinc-400 mt-1">Default is Oct 1 to Dec 31. 92 days. Adjust if you start late. Jan 1 is still graduation.</p>
            ...
            {onboardStep === 3 && (
              <div className="mt-6">
                ...
                <p className="text-sm text-zinc-400 mt-1">Choose three to ten. Three tiers. All free.</p>
                ...
                <div className="mt-6 rounded-xl bg-zinc-950 border border-zinc-800 p-3"><div className="text-xs font-mono tracking-widest text-zinc-400">Custom habit</div><div className="mt-2 flex gap-2"><Input value={customName} onChange={e => setCustomName(e.target.value)} placeholder="No sugar, 3L water" onKeyDown={e => e.key === 'Enter' && addCustom()} /><Button variant="secondary" onClick={addCustom}>Add</Button></div>{customList.length > 0 && (<div className="mt-3 flex flex-wrap gap-2">{customList.map(c => (<Badge key={c.id} variant="secondary" className="gap-1.5">{c.name} <button onClick={() => { setCustomList(prev => prev.filter(x => x.id !== c.id)); setTmpSelected(s => { const n = new Set(s); n.delete(c.id); return n }) }} className="ml-1 hover:text-destructive"><X size={12} /></button></Badge>))}</div>)}</div>
      ...
      <footer className="max-w-[980px] mx-auto px-6 py-10 border-t border-zinc-800/60 mt-8">
        <div className="flex flex-col gap-3 text-[11px] font-mono tracking-wide text-zinc-600">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 border-t border-zinc-900 pt-3">
            <span>Built on <a href="https://vercel.com" target="_blank" rel="noreferrer" className="hover:text-white">Vercel</a>. Data stays local. No tracking</span>
