...
function Logo({ size = 32 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" aria-hidden>
      <circle cx="32" cy="32" r="31" fill="#18181b" stroke="#3f3f46" strokeWidth="1.5" />
      <path d="M12 45 L26 18 L32 30 L38 22 L52 45 Z" fill="none" stroke="#fafafa" strokeWidth="2.4" strokeLinejoin="round" strokeLinecap="round" />
      <circle cx="32" cy="26" r="3.2" fill="#fafafa" />
      <path d="M28 34.5 C28 31.4 29.8 29.2 32 29.2 C34.2 29.2 36 31.4 36 34.5 L33.6 38.5 L30.4 38.5 Z" fill="#fafafa" />
      <path d="M25.5 39 Q32 43.5 38.5 39" stroke="#71717a" strokeWidth="1.5" fill="none" strokeLinecap="round" />
    </svg>
  )
}
