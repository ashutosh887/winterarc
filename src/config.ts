...
export const quotes: { q: string; a: string }[] = [
  ...
  { q: "A year from now you will wish you had started today.", a: "Anonymous" },
  ...
  { q: "Do the hard jobs first. The easy jobs will take care of themselves.", a: "Anonymous" },
